...
11. In run 10, I am running the same test as run 09, but with the bug in the code corrected - in the thresholding function in the utils.py file - but I am running the loop just twice rather than 5 times since 5 times takes too long
