...
19. In run 18 I am trying to see if my model is able to find the results for just a DAG rather than an ADMG, I am using linear gaussian data with equal variances since that way the DAG is identifiable.
