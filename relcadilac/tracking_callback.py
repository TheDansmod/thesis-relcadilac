...
class TrackingCallback(BaseCallback):
    def __init__(self, total_timesteps, num_samples, verbose = 0, do_entropy_annealing=True, initial_entropy=0.4, min_entropy=0.005, cycle_length=10_000, damping_factor=0.5):
